...
object Function {
  ...
  def map3[T1, T2, T3, R](t1y: Try[T1], t2y: Try[T2], t3y: Try[T3])(f: (T1, T2, T3) => R): Try[R] =
    t1y flatMap(a => t2y flatMap(b => t3y map(r => f(a, b, r))))
  // TO BE IMPLEMENTED
  ...
  def map7[T1, T2, T3, T4, T5, T6, T7, R](t1y: Try[T1], t2y: Try[T2], t3y: Try[T3], t4y: Try[T4], t5y: Try[T5], t6y: Try[T6], t7y: Try[T7])
    ...
    for(a<-t1y; b<-t2y; c<-t3y; d<-t4y; e<-t5y; g<-t6y; h<-t7y) yield f(a, b, c, d, e, g, h)
  // TO BE IMPLEMENTED
  ...
  def invert2[T1, T2, R](f: T1 => T2 => R): T2 => T1 => R = {a: T2 => r: T1 => f(r)(a)} // TO BE IMPLEMENTED
  ...
  def invert3[T1, T2, T3, R](f: T1 => T2 => T3 => R): T3 => T2 => T1 => R = {a: T3 => b: T2 => r: T1 => f(r)(b)(a) } // TO BE IMPLEMENTED
  ...
  def invert4[T1, T2, T3, T4, R](f: T1 => T2 => T3 => T4 => R): T4 => T3 => T2 => T1 => R = {a: T4 => b: T3 => c: T2 => r: T1 => f(r)(c)(b)(a) } // TO BE IMPLEMENTED
  ...
  def uncurried2[T1, T2, T3, R](f: T1 => T2 => T3 => R): (T1, T2) => T3 => R = (a: T1, r: T2) => f(a)(r) // TO BE IMPLEMENTED
  ...
  def uncurried3[T1, T2, T3, T4, R](f: T1 => T2 => T3 => T4 => R): (T1, T2, T3) => T4 => R = (a: T1, b: T2, r: T3) => f(a)(b)(r) // TO BE IMPLEMENTED
  ...
  def uncurried7[T1, T2, T3, T4, T5, T6, T7, T8, R](f: T1 => T2 => T3 => T4 => T5 => T6 => T7 => T8 => R): (T1, T2, T3, T4, T5, T6, T7) => T8 => R =
    (a: T1, b: T2, c: T3, d: T4, e: T5, g: T6, r: T7) => f(a)(b)(c)(d)(e)(g)(r)// TO BE IMPLEMENTED
